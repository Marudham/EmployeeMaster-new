...
export default function RaiseReq({ commonMessage, setCommonMessage }) {
 ...
 const formik = useFormik({
    initialValues: {
      ...
      addedByAdminId: employee ? employee.addedByAdminId : '',
      ...
      percentage10: employee ? employee.percentage10 : '',
      percentage12: employee ? employee.percentage12 : '',
      percentageDeg: employee ? employee.percentageDeg : '',
    ...
    onSubmit: async (values) => {
      try {
        const response = await axios.put("http://localhost:8080/ems/controller/employeeRequest", values);
  ...
  return (
    <div className='eu-container'>
      ...
      <h2 className='eu-header'>Raise Request</h2>
      <form className='eu-form' onSubmit={formik.handleSubmit}>
        ...
        <div className='eu-form-group'>
          ...
          {formik.touched.address && formik.errors.address && (
            ...
            <div className='eu-form-group'>
            <button className='au-button' type='submit'>Submit</button>
            </div>
        </form>
    </div>
  )
